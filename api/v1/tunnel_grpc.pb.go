...
const (
	TunnelService_Tunnel_FullMethodName = "/tunnel.v1.TunnelService/Tunnel"
)
...
type TunnelServiceClient interface {
	...
	Tunnel(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Packet, Packet], error)
}
...
func (c *tunnelServiceClient) Tunnel(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Packet, Packet], error) {
...
type TunnelService_TunnelClient = grpc.BidiStreamingClient[Packet, Packet]
...
type TunnelServiceServer interface {
	// The core RPC of the tunnel, a long-lived bidirectional stream
	Tunnel(grpc.BidiStreamingServer[Packet, Packet]) error
...
func (UnimplementedTunnelServiceServer) Tunnel(grpc.BidiStreamingServer[Packet, Packet]) error {
...
func _TunnelService_Tunnel_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TunnelServiceServer).Tunnel(&grpc.GenericServerStream[Packet, Packet]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TunnelService_TunnelServer = grpc.BidiStreamingServer[Packet, Packet]
