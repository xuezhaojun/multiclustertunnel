...
func NewClient(ctx context.Context, config *Config) *Client {
	...
	return &Client{
		config: config,
		lcm:    newPacketConnectionManager(ctx),
	}
}
...
func (c *Client) processIncoming(grpcStream v1.TunnelService_TunnelClient) error {
	for {
...
func (c *Client) processOutgoing(grpcStream v1.TunnelService_TunnelClient) error {
